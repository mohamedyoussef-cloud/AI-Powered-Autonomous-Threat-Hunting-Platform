...
EXACT_CSV = (
    OUTPUT_DIR
    / "exact_event_matches_v2_1.csv"
)

SOURCE_CSV = (
    OUTPUT_DIR
    / "source_requirement_matches_v2_1.csv"
)

REVIEW_CSV = (
    OUTPUT_DIR
    / "semantic_review_items_v2_1.csv"
)

SUMMARY_FILE = (
    OUTPUT_DIR
    / "semantic_match_audit_v2_1_summary.json"
)
